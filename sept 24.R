...
# One row is a contribution record that is > $200 in 2024 in Pennsylvania.
# Is one row one contributor?
...
# People are saying SELF-EMPLOYED, SELF EMPLOYED, SELF, HOMEMAKER, 
# NOT-EMPLOYED, NOT EMPLOYED, SELF, RETIRED, RETIREE
